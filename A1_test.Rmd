...
map2 <- inner_join(map, border2, by = c("id" = "map_id"))
...
```{r}
#map <- inner_join(Map_poland, counties_data, by = c("id" = "map_id_0"))
#map2 <- inner_join(map, border, by = c("id" = "map_id"))
